...
const mockRetroreflectivityData = [
  { period: '2023 Q1', real: 180, predicted: 175 },
  { period: '2023 Q2', real: 165, predicted: 170 },
  { period: '2023 Q3', real: 140, predicted: 155 },
  { period: '2023 Q4', real: 125, predicted: 130 },
  { period: '2024 Q1', real: 110, predicted: 115 },
  { period: '2024 Q2', real: 98, predicted: 105 },
  { period: '2024 Q3', real: 115, predicted: 90 },
  { period: '2024 Q4', real: 135, predicted: 140 },
  { period: '2025 Q1', real: 125, predicted: 130 },
  { period: '2025 Q2', real: 120, predicted: 125 },
  { period: '2025 Q3', real: 115, predicted: 120 },
  { period: '2025 Q4', real: 110, predicted: 115 },
  { period: '2026 Q1', predicted: 105 },
  { period: '2026 Q2', predicted: 95 },
  { period: '2026 Q3', predicted: 85 },
  { period: '2026 Q4', predicted: 75 },
  { period: '2027 Q1', predicted: 65 },
  { period: '2027 Q2', predicted: 55 },
  { period: '2027 Q3', predicted: 45 },
  { period: '2027 Q4', predicted: 35 },
];

// Estado de Conservação das Placas (% adequadas)
const mockSignConditionData = [
  { period: '2023 Q1', real: 95, predicted: 94 },
  { period: '2023 Q2', real: 92, predicted: 93 },
  { period: '2023 Q3', real: 88, predicted: 90 },
  { period: '2023 Q4', real: 85, predicted: 86 },
  { period: '2024 Q1', real: 82, predicted: 83 },
  { period: '2024 Q2', real: 79, predicted: 80 },
  { period: '2024 Q3', real: 83, predicted: 77 },
  { period: '2024 Q4', real: 87, predicted: 85 },
  { period: '2025 Q1', real: 84, predicted: 82 },
  { period: '2025 Q2', real: 81, predicted: 80 },
  { period: '2025 Q3', real: 78, predicted: 77 },
  { period: '2025 Q4', real: 75, predicted: 74 },
  { period: '2026 Q1', predicted: 72 },
  { period: '2026 Q2', predicted: 68 },
  { period: '2026 Q3', predicted: 65 },
  { period: '2026 Q4', predicted: 62 },
  { period: '2027 Q1', predicted: 58 },
  { period: '2027 Q2', predicted: 55 },
  { period: '2027 Q3', predicted: 52 },
  { period: '2027 Q4', predicted: 48 },
];
