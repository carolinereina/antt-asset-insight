...
const mockEBITDAData = [
  { period: '2023 Q1', real: 22.5, predicted: 22.0 },
  { period: '2023 Q2', real: 23.1, predicted: 23.0 },
  { period: '2023 Q3', real: 21.8, predicted: 22.5 },
  { period: '2023 Q4', real: 20.2, predicted: 21.0 },
  { period: '2024 Q1', real: 18.9, predicted: 19.5 },
  { period: '2024 Q2', real: 17.3, predicted: 18.0 },
  { period: '2024 Q3', real: 19.8, predicted: 17.0 },
  { period: '2024 Q4', real: 21.5, predicted: 20.5 },
  { period: '2025 Q1', real: 22.0, predicted: 21.8 },
  { period: '2025 Q2', real: 23.4, predicted: 23.0 },
  { period: '2025 Q3', real: 24.1, predicted: 23.8 },
  { period: '2025 Q4', real: 24.8, predicted: 24.5 },
  { period: '2026 Q1', predicted: 25.2 },
  { period: '2026 Q2', predicted: 25.8 },
  { period: '2026 Q3', predicted: 26.4 },
  { period: '2026 Q4', predicted: 27.0 },
  { period: '2027 Q1', predicted: 27.6 },
  { period: '2027 Q2', predicted: 28.2 },
  { period: '2027 Q3', predicted: 28.8 },
  { period: '2027 Q4', predicted: 29.4 },
];

// ROI Investimentos (%)
const mockROIData = [
  { period: '2023 Q1', real: 15.2, predicted: 15.0 },
  { period: '2023 Q2', real: 16.1, predicted: 16.0 },
  { period: '2023 Q3', real: 16.8, predicted: 16.5 },
  { period: '2023 Q4', real: 14.9, predicted: 15.5 },
  { period: '2024 Q1', real: 13.2, predicted: 14.0 },
  { period: '2024 Q2', real: 12.1, predicted: 13.0 },
  { period: '2024 Q3', real: 14.8, predicted: 12.5 },
  { period: '2024 Q4', real: 16.5, predicted: 15.8 },
  { period: '2025 Q1', real: 17.2, predicted: 16.9 },
  { period: '2025 Q2', real: 18.2, predicted: 17.8 },
  { period: '2025 Q3', real: 18.8, predicted: 18.5 },
  { period: '2025 Q4', real: 19.5, predicted: 19.2 },
  { period: '2026 Q1', predicted: 20.0 },
  { period: '2026 Q2', predicted: 20.6 },
  { period: '2026 Q3', predicted: 21.2 },
  { period: '2026 Q4', predicted: 21.8 },
  { period: '2027 Q1', predicted: 22.4 },
  { period: '2027 Q2', predicted: 23.0 },
  { period: '2027 Q3', predicted: 23.6 },
  { period: '2027 Q4', predicted: 24.2 },
];
