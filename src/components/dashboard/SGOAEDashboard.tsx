...
const mockOAEConditionData = [
  ...
  { period: '2023 Q3', real: 3.8, predicted: 3.9 },
  { period: '2023 Q4', real: 3.5, predicted: 3.6 },
  { period: '2024 Q1', real: 3.3, predicted: 3.4 },
  { period: '2024 Q2', real: 2.9, predicted: 3.1 },
  { period: '2024 Q3', real: 2.7, predicted: 2.8 },
  { period: '2024 Q4', real: 2.8, predicted: 2.6 },
  { period: '2025 Q1', real: 2.5, predicted: 2.4 },
  { period: '2025 Q2', real: 2.3, predicted: 2.2 },
  { period: '2025 Q3', real: 2.1, predicted: 2.0 },
  { period: '2025 Q4', real: 1.9, predicted: 1.8 },
  { period: '2026 Q1', predicted: 1.7 },
  { period: '2026 Q2', predicted: 1.5 },
  { period: '2026 Q3', predicted: 1.3 },
  { period: '2026 Q4', predicted: 1.1 },
  { period: '2027 Q1', predicted: 0.9 },
  { period: '2027 Q2', predicted: 0.7 },
  { period: '2027 Q3', predicted: 0.5 },
  { period: '2027 Q4', predicted: 0.3 },
];

// Estado de Conservação Elementos Estruturais (0-5)
const mockStructuralData = [
  { period: '2023 Q1', real: 4.5, predicted: 4.4 },
  { period: '2023 Q2', real: 4.3, predicted: 4.3 },
  { period: '2023 Q3', real: 4.1, predicted: 4.1 },
  { period: '2023 Q4', real: 3.8, predicted: 3.9 },
  { period: '2024 Q1', real: 3.6, predicted: 3.7 },
  { period: '2024 Q2', real: 3.4, predicted: 3.5 },
  { period: '2024 Q3', real: 3.2, predicted: 3.3 },
  { period: '2024 Q4', real: 3.1, predicted: 3.1 },
  { period: '2025 Q1', real: 2.9, predicted: 2.8 },
  { period: '2025 Q2', real: 2.7, predicted: 2.6 },
  { period: '2025 Q3', real: 2.5, predicted: 2.4 },
  { period: '2025 Q4', real: 2.3, predicted: 2.2 },
  { period: '2026 Q1', predicted: 2.0 },
  { period: '2026 Q2', predicted: 1.8 },
  { period: '2026 Q3', predicted: 1.6 },
  { period: '2026 Q4', predicted: 1.4 },
  { period: '2027 Q1', predicted: 1.2 },
  { period: '2027 Q2', predicted: 1.0 },
  { period: '2027 Q3', predicted: 0.8 },
  { period: '2027 Q4', predicted: 0.6 },
];
